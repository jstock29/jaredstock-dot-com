    ...
    render() {
        ...
        return (
            <div>
                ...
                <p className="about-desc">I'm a technologist everywhere and senior developer at <a
                    href="https://www.thoughtworks.com/" target="_blank" rel="noreferrer"
                    className="link">Thoughtworks</a>. I
                    love podcasts, running in Central Park, reading too much sci-fi, my cat, and
                    hiking to stand on top of tall things. I can also tell you where to find the best bagel in New York.
                </p>
            </div>
